...
const scheduleData = [
    // ПОНЕДІЛОК
    { day: 1, time: "09:00-10:20", name: "Менеджмент та маркетинг (Л)", info: "9т (Кухта П.В.) https://teams.microsoft.com/meet/39511022754590?p=WmdeNFrT7A9zLhcUQJ", dates: ["2026-01-26", "2026-02-02", "2026-02-09", "2026-02-16", "2026-02-23", "2026-03-02", "2026-03-09", "2026-03-16", "2026-03-23"], sub: 0 },
    ...
    { day: 4, time: "12:10-13:30", name: "КЛ та дискретна математика", info: "14т (Терещук Г.М.)", range: ["2026-02-12", "2026-05-14"], sub: 0 },
    { day: 4, time: "13:40-15:00", name: "КЛ та дискретна математика (Пр)", info: "6т (Терещук Г.М.)", range: ["2026-04-09", "2026-05-14"], sub: 0 },
    ...
    { day: 5, time: "13:40-15:00", name: "Побудова корп. мереж (лаб)", info: "3 тижні", dates: ["2026-02-20", "2026-04-03", "2026-04-10"], sub: 0 }
];
